...
- `results/cross_site/<train>2<test>/*_test_outputs.csv` generated by `benchmarking/cross_site.py` when
  `save_test_outputs: true` in the YAML config.
...
- `results/cross_site/<train>2<test>/*_pipeline_abbreviations.csv` maps pipeline abbrev (P0001, ...) to
  full specs. Used by compare_pipelines.
...
Library usage from a notebook or script:
    ...
    df = pd.read_csv("results/cross_site/ihb2china/cross_site_quick_classification_test_outputs.csv")
    abbrev = pd.read_csv("results/cross_site/ihb2china/cross_site_quick_classification_pipeline_abbreviations.csv")
